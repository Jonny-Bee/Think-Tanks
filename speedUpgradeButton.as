package 
{
	...
	public class speedUpgradeButton extends MovieClip 
	{
		...
		public function speedUpgradeButton(gm,lvl,cst)
		{
			game = gm;
			...
			var ps = Math.floor(game.gameData.playerSpeed * 10);
			if (ps == limit)
			{
				unlocked = true;
